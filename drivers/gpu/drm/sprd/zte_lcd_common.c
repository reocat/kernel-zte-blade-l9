...
static ssize_t abnormal_shutdown_flag_show(struct device *d, struct device_attribute *attr, char *buf)
{
	return snprintf(buf, 80, "%d\n", zte_abnormal_shutdown_flag);
}
static ssize_t abnormal_shutdown_flag_store(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
	unsigned int input;
...
static DEVICE_ATTR_RW(abnormal_shutdown_flag);
static ssize_t abnormal_shutdown_times_show(struct device *d, struct device_attribute *attr, char *buf)
{
	return snprintf(buf, 80, "%d\n", zte_abnormal_shutdown_times);
}
static ssize_t abnormal_shutdown_times_store(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
	unsigned int input;
...
static DEVICE_ATTR_RW(abnormal_shutdown_times);
#endif
