...
void tlsc6x_tpd_register_fw_class(void)
{
	...
	tpd_fw_cdev.max_x = g_tp_drvdata->platform_data->x_res_max;
	tpd_fw_cdev.max_y = g_tp_drvdata->platform_data->y_res_max;
	tpd_fw_cdev.edge_report_limit[0] = tlsc_left_edge_limit_v;
	tpd_fw_cdev.edge_report_limit[1] = tlsc_right_edge_limit_v;
	tpd_fw_cdev.edge_report_limit[2] = tlsc_left_edge_limit_h;
	tpd_fw_cdev.edge_report_limit[3] = tlsc_right_edge_limit_h;
	tpd_fw_cdev.long_pess_suppression[0] = tlsc_left_edge_long_pess_v;
	tpd_fw_cdev.long_pess_suppression[1] = tlsc_right_edge_long_pess_v;
	tpd_fw_cdev.long_pess_suppression[2] = tlsc_left_edge_long_pess_h;
	tpd_fw_cdev.long_pess_suppression[3] = tlsc_right_edge_long_pess_h;
	tpd_fw_cdev.long_press_max_count = tlsc_long_press_max_count;
	tpd_fw_cdev.edge_long_press_check = tlsc_edge_long_press_check;
#endif
