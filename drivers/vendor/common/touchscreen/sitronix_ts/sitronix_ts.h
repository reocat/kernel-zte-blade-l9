...
#ifdef ST_DEBUG_EN
#define STX_DEBUG(fmt, args...) pr_info("[SITRONIX]" fmt "\n", ##args)
#define STX_FUNC_ENTER() pr_info("[SITRONIX]%s: Enter\n", __func__)
#define STX_FUNC_EXIT() pr_info("[SITRONIX]%s: Exit(%d)\n", __func__, __LINE__)
#else /* #if ST_DEBUG_EN */
...
#define STX_INFO(fmt, args...)  pr_info("[SITRONIX][Info]" fmt "\n", ##args)
#define STX_ERROR(fmt, args...)  pr_err("[SITRONIX][Error]" fmt "\n", ##args)
