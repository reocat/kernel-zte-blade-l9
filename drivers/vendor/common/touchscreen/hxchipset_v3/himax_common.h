...
#define HIMAX_DRIVER_VER "2.0.0.77_ABCD1234_01"
 ...
 */
#define BOOT_UPGRADE_FWNAME  private_ts->CTPM_firmware_name
#if defined(HX_ZERO_FLASH)
#define MPAP_FWNAME  private_ts->himax_mp_firmware_name
#endif
#endif
...
#define HX_MAX_WRITE_SZ    (64 * 1024)
...
/******* SPI-start *******/
	...
	uint8_t *xfer_buff;
#ifdef CONFIG_SPI_QCOM_GENI
	struct spi_geni_qcom_ctrl_data spi_ctrl;
#endif
/******* SPI-end *******/
...
#endif
	char CTPM_firmware_name[50];
#ifdef HX_ZERO_FLASH
	char himax_default_firmware_name[50];
	char himax_mp_firmware_name[50];
#endif
	char hx_criteria_csv_name[30];
	char g_hx_save_file_path[20];
	char g_hx_save_file_name[50];
};
